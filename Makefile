...
protoc: clean
	...
	@cd ./app/proto/user_management && protoc -I. --go_out=../../interface/grpc/proto/user_management --go-grpc_out=require_unimplemented_servers=false:../../interface/grpc/proto/user_management *.proto