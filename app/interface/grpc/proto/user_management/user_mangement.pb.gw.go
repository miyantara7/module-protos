...
/*
Package user_management is a reverse proxy.
...
func request_UsermanagementService_Login_0(ctx context.Context, marshaler runtime.Marshaler, client UsermanagementServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_UsermanagementService_Login_0(ctx context.Context, marshaler runtime.Marshaler, server UsermanagementServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq LoginRequest
	var metadata runtime.ServerMetadata
...
func RegisterUsermanagementServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UsermanagementServiceServer) error {
	...
	mux.Handle("POST", pattern_UsermanagementService_Login_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/user_management.UsermanagementService/Login", runtime.WithHTTPPathPattern("/user_management.UsermanagementService/Login"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_UsermanagementService_Login_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_UsermanagementService_Login_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterUsermanagementServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UsermanagementServiceClient) error {
	...
	mux.Handle("POST", pattern_UsermanagementService_Login_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/user_management.UsermanagementService/Login", runtime.WithHTTPPathPattern("/user_management.UsermanagementService/Login"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_UsermanagementService_Login_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_UsermanagementService_Login_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"user_management.UsermanagementService", "Login"}, ""))
)

var (
	forward_UsermanagementService_Login_0 = runtime.ForwardResponseMessage
)
