...
func RegisterTransactionNotpoolServiceServer(s grpc.ServiceRegistrar, srv TransactionNotpoolServiceServer) {
	s.RegisterService(&TransactionNotpoolService_ServiceDesc, srv)
}
...
// TransactionNotpoolService_ServiceDesc is the grpc.ServiceDesc for TransactionNotpoolService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var TransactionNotpoolService_ServiceDesc = grpc.ServiceDesc{
