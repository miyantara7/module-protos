...
func RegisterTopUpServicesServer(s grpc.ServiceRegistrar, srv TopUpServicesServer) {
	s.RegisterService(&TopUpServices_ServiceDesc, srv)
}
...
// TopUpServices_ServiceDesc is the grpc.ServiceDesc for TopUpServices service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var TopUpServices_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "app/proto/top_up_service/top_up_service.proto",
}
