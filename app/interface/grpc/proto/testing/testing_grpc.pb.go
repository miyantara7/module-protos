...
type TopUpServicesClient interface {
	...
	Payment(ctx context.Context, in *TopUpRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *topUpServicesClient) TopUp(ctx context.Context, in *TopUpRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/testing.TopUpServices/TopUp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *topUpServicesClient) Payment(ctx context.Context, in *TopUpRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/testing.TopUpServices/Payment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedTopUpServicesServer
// for forward compatibility
type TopUpServicesServer interface {
	TopUp(context.Context, *TopUpRequest) (*emptypb.Empty, error)
	Payment(context.Context, *TopUpRequest) (*emptypb.Empty, error)
	mustEmbedUnimplementedTopUpServicesServer()
}

// UnimplementedTopUpServicesServer must be embedded to have forward compatible implementations.
...
func (UnimplementedTopUpServicesServer) Payment(context.Context, *TopUpRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Payment not implemented")
}
func (UnimplementedTopUpServicesServer) mustEmbedUnimplementedTopUpServicesServer() {}
...
func _TopUpServices_TopUp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/testing.TopUpServices/TopUp",
	}
...
func _TopUpServices_Payment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/testing.TopUpServices/Payment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopUpServicesServer).Payment(ctx, req.(*TopUpRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _TopUpServices_serviceDesc = grpc.ServiceDesc{
	ServiceName: "testing.TopUpServices",
	...
	Metadata: "app/proto/testing/testing.proto",
}
